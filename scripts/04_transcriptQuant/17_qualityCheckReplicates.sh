...
--matrix /lustre04/scratch/janayfox/afFishRNA/quant_output/quant_output_cleanedReads/kallisto_output/BA/matrix_kallisto_BA/BA_cl_kal.isoform.counts.matrix \
--samples /lustre04/scratch/janayfox/afFishRNA/samples_BA.txt --log2 --CPM --min_rowSums 10 --compare_replicates

singularity exec -e --env-file envfile -B /lustre04/scratch/janayfox/afFishRNA \
trinityrnaseq.v2.15.0.simg /usr/local/bin/Analysis/DifferentialExpression/PtR  \
--matrix /lustre04/scratch/janayfox/afFishRNA/quant_output/quant_output_cleanedReads/kallisto_output/BN/matrix_kallisto_BN/BN_cl_kal.isoform.counts.matrix \
--samples /lustre04/scratch/janayfox/afFishRNA/samples_BN.txt --log2 --CPM --min_rowSums 10 --compare_replicates

#salmon
singularity exec -e --env-file envfile -B /lustre04/scratch/janayfox/afFishRNA \
trinityrnaseq.v2.15.0.simg /usr/local/bin/Analysis/DifferentialExpression/PtR  \
--matrix /lustre04/scratch/janayfox/afFishRNA/quant_output/quant_output_cleanedReads/salmon_output/BA/matrix_salmon_BA/BA_cl_sal.isoform.counts.matrix \
--samples /lustre04/scratch/janayfox/afFishRNA/samples_BA.txt --log2 --CPM --min_rowSums 10 --compare_replicates

singularity exec -e --env-file envfile -B /lustre04/scratch/janayfox/afFishRNA \
trinityrnaseq.v2.15.0.simg /usr/local/bin/Analysis/DifferentialExpression/PtR  \
--matrix /lustre04/scratch/janayfox/afFishRNA/quant_output/quant_output_cleanedReads/salmon_output/BN/matrix_salmon_BN/BN_cl_sal.isoform.counts.matrix \
--samples /lustre04/scratch/janayfox/afFishRNA/samples_BN.txt --log2 --CPM --min_rowSums 10 --compare_replicates
...
trinityrnaseq.v2.15.0.simg /usr/local/bin/Analysis/DifferentialExpression/PtR  \
--matrix /lustre04/scratch/janayfox/afFishRNA/quant_output/quant_output_cleanedReads/kallisto_output/BA/matrix_kallisto_BA/BA_cl_kal.isoform.counts.matrix \
--samples /lustre04/scratch/janayfox/afFishRNA/samples_BA.txt --log2 --CPM --min_rowSums 10 --sample_cor_matrix

singularity exec -e --env-file envfile -B /lustre04/scratch/janayfox/afFishRNA \
trinityrnaseq.v2.15.0.simg /usr/local/bin/Analysis/DifferentialExpression/PtR  \
--matrix /lustre04/scratch/janayfox/afFishRNA/quant_output/quant_output_cleanedReads/kallisto_output/BN/matrix_kallisto_BN/BN_cl_kal.isoform.counts.matrix \
--samples /lustre04/scratch/janayfox/afFishRNA/samples_BN.txt --log2 --CPM --min_rowSums 10 --sample_cor_matrix
